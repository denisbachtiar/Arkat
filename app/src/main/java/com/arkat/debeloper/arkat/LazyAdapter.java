...
//        imageLoader = new ImageLoader(activity.getApplicationContext());
    ...
    public View getView(int position, View convertView, ViewGroup
        ...
        id_berita.setText(daftar_berita.get(FragmentGallery.TAG_ID));
        judul.setText(daftar_berita.get(FragmentGallery.TAG_JUDUL));

//        imageLoader.DisplayImage(daftar_berita.get(BeritaUtama.TAG_GAMBAR),thumb_image);
        Picasso.with(activity.getApplicationContext())
                .load(daftar_berita.get(FragmentGallery.TAG_GAMBAR))
