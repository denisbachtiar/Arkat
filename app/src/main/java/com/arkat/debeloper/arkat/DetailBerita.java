...
public class DetailBerita extends Activity {
    ...
    public static final String TAG_ISI = "keterangan";
    public static final String TAG_GAMBAR = "gambar";
    private static final String url_detail_berita =
            "http://watonmerch.co.id/android/detail_blog.php";
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        idblog = i.getStringExtra(TAG_ID);
    ...
    class AmbilDetailBerita extends AsyncTask<String, String,
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                params1.add(new
                        BasicNameValuePair("id_blog",idblog));
